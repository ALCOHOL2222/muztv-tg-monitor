...
def row_matches_exact(text: str, term_variants_map):
    text_norm = norm(text)
    tokens = tokenize(text_norm)

    for variants in term_variants_map:
...
if term_variants_map:
    ...
    mask = search_blob.apply(lambda x: row_matches_exact(x, term_variants_map))
